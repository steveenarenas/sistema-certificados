  ...
  <div class="content">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <center><h1 class="m-0" style="color: #0D3B5A;"><strong>REGISTRO DE UN NUEVO ROL</strong></h1></center>
          </div><!-- /.col -->
    ...
    <!-- Main content -->
    <div class="content" style="width: 1500px; margin-left: 25%;">
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-6">
          <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Ingrese el nombre del nuevo rol</h3>
